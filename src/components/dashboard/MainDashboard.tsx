      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <JugaProgressCard title="Meta Mensal" description="Vendas do mês" progress={68} total={100000} current={68000} color="primary" />
            <JugaProgressCard title="Satisfação" description="NPS clientes" progress={85} color="success" />
          </div>
