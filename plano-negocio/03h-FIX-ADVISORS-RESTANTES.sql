-- FIX: Advisors restantes — search_path mutável e policy de financial_transactions
-- Projeto: lfxietcasaooenffdodr
-- Aplicar apenas após validação e aprovação do usuário

-- ============================================================
-- 1. Adicionar SET search_path em funções públicas restantes
-- ============================================================
...
-- ============================================================
-- 2. Criar policy de tenant para financial_transactions
-- ============================================================
