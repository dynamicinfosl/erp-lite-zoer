-- =============================================
-- POPULAR TODAS AS TABELAS COM DADOS DE TESTE
...
SELECT 'EXEMPLO PRODUTOS' as tipo, name, price, stock FROM public.products WHERE tenant_id = '11111111-1111-1111-1111-111111111111' LIMIT 3;
