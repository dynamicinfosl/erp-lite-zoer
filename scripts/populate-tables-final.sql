-- =============================================
-- POPULAR TABELAS COM DADOS DE TESTE (VERSÃO FINAL)
...
-- 2. Inserir produtos de teste (incluindo sale_price obrigatório)
...
-- 6. Verificar alguns dados de exemplo
SELECT 'EXEMPLO TRANSACOES' as tipo, description, amount, transaction_type FROM public.financial_transactions WHERE tenant_id = '11111111-1111-1111-1111-111111111111' LIMIT 3;
SELECT 'EXEMPLO PRODUTOS' as tipo, name, sale_price, category FROM public.products WHERE tenant_id = '11111111-1111-1111-1111-111111111111' LIMIT 3;
SELECT 'EXEMPLO VENDAS' as tipo, total_amount, payment_method, status FROM public.sales WHERE tenant_id = '11111111-1111-1111-1111-111111111111' LIMIT 3;
SELECT 'EXEMPLO ENTREGAS' as tipo, customer_name, status, delivery_date FROM public.deliveries WHERE tenant_id = '11111111-1111-1111-1111-111111111111' LIMIT 3;
